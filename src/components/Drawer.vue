      ...
      <v-list-item-group>
        <div v-for="(item, i) in itemsDocs" :key="i">
          <v-list-item
            ...
            v-if="!item.external"
          >
            <v-list-item-icon class="shadow border-radius-md mx-1 align-center" style="padding:2px 5px">
