<template>
  <v-card class="card-shadow border-radius-xl">
    <div class="px-4 pt-4">
      <h6 class="text-h6 font-weight-bold text-typo">Categories</h6>
    </div>
    <div class="px-4 pt-4 pb-3">
      <v-list>
        <v-list-item-group class="border-radius-sm">
          <v-list-item class="px-0 border-radius-sm mb-3">
            <v-avatar
              size="32"
              class="
                text-white
            ...
            <v-list-item-content class="py-0">
              <div class="d-flex flex-column">
                <h6 class="mb-1 text-typo text-sm font-weight-bold">Devices</h6>
          ...
          <v-list-item class="px-0 border-radius-sm mb-3">
            ...
            <v-list-item-content class="py-0">
              <div class="d-flex flex-column">
                <h6 class="mb-1 text-typo text-sm font-weight-bold">Tickets</h6>
                <span class="text-xs text-body"
                  >123 closed,
