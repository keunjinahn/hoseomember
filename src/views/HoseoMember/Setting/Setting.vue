<template>
  <v-container fluid class="py-6">
      ...
      <v-col lg="4" sm="8">
        <v-tabs background-color="transparent" class="text-left">
          ...
          <v-tab :ripple="false" href="#tab-1">
            <span class="ms-1">MOT 회원 정보 등록</span>
          </v-tab>
        </v-tabs>
      </v-col>
    </v-row>
    <v-row>
            ...
            <v-list>
              <v-list-item-group class="border-radius-sm">
                  ...
                  <v-list-item-content class="py-0">
                    <a href="#profile" class="text-decoration-none">
                      <div class="d-flex flex-column">
                        <span class="mb-1 text-body text-sm">프로파일</span>
                      </div>
                    </a>
                  </v-list-item-content>
                </v-list-item>
                ...
                <v-list-item class="px-2 border-radius-sm mb-1">
                  ...
                  <v-list-item-content class="py-0">
                    <a href="#basicinfo" class="text-decoration-none">
                      <div class="d-flex flex-column">
                        <span class="mb-1 text-body text-sm">기본인적사항</span>
                      </div>
                    </a>
                  </v-list-item-content>
                </v-list-item>
                ...
                <v-list-item class="px-2 border-radius-sm mb-1">
                  ...
                  <v-list-item-content class="py-0">
                    <a href="#intructioninfo" class="text-decoration-none">
                      <div class="d-flex flex-column">
                ...
                <v-list-item class="px-2 border-radius-sm mb-1">
                  ...
                  <v-list-item-content class="py-0">
                    <a href="#career" class="text-decoration-none">
                      <div class="d-flex flex-column">
                        <span class="mb-1 text-body text-sm">주요경력</span>
                      </div>
                    </a>
                  </v-list-item-content>
                </v-list-item>
                ...
                <v-list-item class="px-2 border-radius-sm mb-1">
                  ...
                  <v-list-item-content class="py-0">
                    <a href="#provideinfo" class="text-decoration-none">
                      <div class="d-flex flex-column">
                        <span class="mb-1 text-body text-sm">제공 정보</span>
                      </div>
                    </a>
                  </v-list-item-content>
                </v-list-item>
                ...
                <v-list-item class="px-2 border-radius-sm mb-1">
                  ...
                  <v-list-item-content class="py-0">
                    <a href="#abltitleinfo" class="text-decoration-none">
                      <div class="d-flex flex-column">
                        <span class="mb-1 text-body text-sm"
                          >ABL 주제</span
                        >
                ...
                <v-list-item class="px-2 border-radius-sm mb-1">
                  ...
                  <v-list-item-content class="py-0">
                    <a href="#allowinfo" class="text-decoration-none">
                      <div class="d-flex flex-column">
                        <span class="mb-1 text-body text-sm">정보공개여부</span>
                      </div>
                    </a>
                  </v-list-item-content>
                </v-list-item>
                ...
                <v-list-item class="px-2 border-radius-sm mb-1">
                  ...
                  <v-list-item-content class="py-0">
                    <a href="#advertisementinfo" class="text-decoration-none">
                      <div class="d-flex flex-column">
                        <span class="mb-1 text-body text-sm"
                          >광고 및 소개URL</span
                        >
      ...
      <v-col lg="9">
        <v-card class="card-shadow px-4 py-4 overflow-hidden border-radius-xl" id="profile">
          <v-row>
            <v-col cols="auto">
...
import IntructionInfo from "./IntructionInfo.vue";
import Career from "./Career.vue";
import ProvideInfo from "./ProvideInfo.vue";
